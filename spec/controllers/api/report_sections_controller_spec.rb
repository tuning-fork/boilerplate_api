...
describe Api::ReportSectionsController do
    ...
    org.grants.create!([
      {
        ...
        reports: [
          Report.new({
            ...
            submitted: true,
            report_sections: [
              ReportSection.new({ title: "Evil Report Section", text: "Lorem ipsum evil", wordcount: 3 }),
            ],
          }),
        ],
      },
    ...
    good_place.grants.create!([
      {
        ...
        reports: [
          Report.new({
            ...
            submitted: true,
            report_sections: [
              ReportSection.new({ title: "Report Section 1", text: "Lorem ipsum 1", wordcount: 3, sort_order: 0 }),
              ReportSection.new({ title: "Report Section 2", text: "Lorem ipsum 2", wordcount: 3, sort_order: 1 }),
            ],
          }),
        ],
      },
      {
        ...
        reports: [
          Report.new({
            ...
            submitted: true,
            report_sections: [
              ReportSection.new({ title: "Janet report", text: "Lorem ipsum janet", wordcount: 3, sort_order: 0 }),
            ],
          }),
        ],
      },
  ...
  describe "GET /organizations/:organization_id/grants/:grant_id/reports/:report_id/report_sections" do
    ...
    it "renders 401 if organization does not exist" do
      ...
      get :index, params: { **params, organization_id: "123" }
    ...
    it "renders 401 if grant does not exist" do
      set_auth_header(chidi)
      get :index, params: { **params, grant_id: "123" }
    ...
    it "renders 401 if report does not exist" do
      set_auth_header(chidi)
      get :index, params: { **params, report_id: "123" }
  ...
  describe "POST /organizations/:organization_id/grants/:grant_id/reports/:report_id/report_sections" do
    ...
    it "renders 401 if report does not exist" do
      set_auth_header(chidi)
      post :create, params: { **new_section_params, report_id: "123" }
  ...
  describe "GET /organizations/:organization_id/grants/:grant_id/reports/:report_id/report_sections/:section_id" do
    ...
    it "renders 401 if report does not exist" do
      set_auth_header(chidi)
      get :show, params: { **params, report_id: "123" }
  ...
  describe "PATCH /organizations/:organization_id/grants/:grant_id/reports/:report_id/report_sections/:section_id" do
    ...
    it "renders 401 if report does not exist" do
      set_auth_header(chidi)
      patch :update, params: { **update_section_params, report_id: "123" }
  ...
  describe "DELETE /organizations/:organization_id/grants/:grant_id/reports/:report_id/report_sections/:section_id" do
    ...
    it "renders 401 if report does not exist" do
      set_auth_header(chidi)
      delete :destroy, params: { **delete_section_params, report_id: "123" }
    ...
    let(:new_section_params) {
      {
        organization_id: good_place.uuid,
        grant_id: good_place.grants.first.uuid,
        report_id: good_place.grants.first.reports.first.uuid,
        title: "New report section",
        text: "This is a new report section",
        wordcount: 6,
      }
