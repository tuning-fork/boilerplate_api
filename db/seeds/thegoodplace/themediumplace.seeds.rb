...
mindy = User.create!({ first_name: "Mindy", email: "mindy@themediumplace.com", password: SecureRandom.hex, active: true })
...
the_medium_place.grants.create!([
  {
    ...
    sections: [
      Section.new({ title: "Overview of the Organization", text: "<p>#{lorem_ipsum}</p>", sort_order: 1, wordcount: 219 }),
    ],
  },
])

the_medium_place.boilerplates.create!([
  { category: category_grey_area, title: "Mission", text: "<p>#{lorem_ipsum}</p>", wordcount: 219 },
])
