...
chidi = User.create!({ first_name: 'Chidi', last_name: 'Anagonye', email: 'canagonye@thegoodplace.com',
                       password: SecureRandom.hex, active: true })
tahani = User.create!({ first_name: 'Tahani', last_name: 'Al-Jamil', email: 'taljamil@thegoodplace.com',
                        password: SecureRandom.hex, active: true })
jason = User.create!({ first_name: 'Jason', last_name: 'Mendoza', email: 'jmendoza@thegoodplace.com',
                       password: SecureRandom.hex, active: true })
elenor = User.create!({ first_name: 'Elenor', last_name: 'Shellstrop', email: 'eshellstrop@thegoodplace.com',
                        password: SecureRandom.hex, active: true })
janet = User.create!({ first_name: 'Janet', last_name: '', email: 'janet@thegoodplace.com', password: SecureRandom.hex,
                       active: true })
michael = User.create!({ first_name: 'Michael', last_name: '', email: 'michael@thegoodplace.com',
                         password: SecureRandom.hex, active: true })
...
the_good_place.boilerplates.create!([
                                      { category: category_general_purpose, title: 'Mission',
                                        text: '<p><span style="color: rgb(102, 102, 102);">MIRA, the Middle Eastern Immigrant and Refugee Alliance, was originally founded in 2009 as the Iraqi Mutual Aid Society by newly-arrived Iraqi refugees, in response to the challenges they faced while adapting to their new lives in the United States. MIRA forges connections between Middle Eastern and American society, and facilitates the preservation and exchange of Middle Eastern culture. Our goal is to foster well-being and self-sufficiency for resettled refugees and immigrants from across the Middle East and beyond, and to use our multilingual and multicultural expertise to tailor our services to the unique needs of our clients— whom we serve regardless of gender, religion, ethnicity, nationality, or family size.​Our staff and volunteers speak Arabic, Assyrian, Kurdish, and Farsi. Almost all arrived to the United States as refugees themselves. These linguistic, cultural, and experiential connections with our Middle Eastern clients distinguish MIRA; there is no comparable organization serving this population in the Chicago area. Over the past ten years since the founding, MIRA has expanded to offer services to refugees, immigrants, asylees, and Special Immigrant Visa holders from all over the world, but we are proud to say that this founding spirit has only grown stronger— MIRA continues to be community-driven, refugee-powered, and closely attuned to the needs and voices of the population we serve.</span></p>', wordcount: 219 },
                                      { category: category_general_purpose, title: 'What We Do',
                                        text: '<p><span style="color: rgb(102, 102, 102);">The Middle Eastern Immigrant and Refugee Alliance (MIRA) fosters the well-being and self-sufficiency of Middle Eastern refugees, immigrants, and asylees in Chicago. MIRA serves as a first point of contact for a diverse client population from around the world, offering culturally competent services for those from the Middle East and Islamic cultures. The immigrants and refugees we serve arrive in the United States facing numerous barriers to full integration into society. Our mandate is to provide them with the tools they need to build successful, stable, enriching lives in their new homes. The primary needs of the community relate to navigating American systems for safety net services, employment, and education; integrating into American society while maintaining distinct cultural and community support and traditions; and undertaking the legal processes necessary for continued life in the United States without undue financial burdens or hardships.</span></p>', wordcount: 146 },
                                      { category: category_cultural_and_community_programming, title: 'Community Engagement and Empowerment Programs',
                                        text: '<p><span style="color: rgb(102, 102, 102);">MIRA provides the resources and structure for Middle Eastern refugees to support one another and welcome new arrivals with what they need to succeed through support groups, community events, and bridge-building activities with the wider Chicago community. In FY18-19 189 MIRA Community Empowerment Clients participated in 645 Empowerment Activities.</span></p>', wordcount: 53 },
                                      { category: category_family_services, title: 'Case Management Program',
                                        text: '<p><span style="color: rgb(102, 102, 102);">MIRA helps Middle Eastern refugees and immigrants access the services they need, including public benefits, healthcare, and referrals to partner organizations or other agencies. In FY18-19 MIRA provided 341 Case Management Clients with 677 Case Management Case Activities.</span></p>', wordcount: 42 },
                                      { category: category_family_services, title: 'Assistance for Families With Children',
                                        text: '<p><span style="color: rgb(102, 102, 102);">MIRA offers a variety of support for families with children, including pre-school and school enrollment, working with teachers and administration, support for struggling students, parental support, and monthly Parents’ Groups.&nbsp;In FY18-19 MIRA provided 120 Child and Family Services Clients with 480 Child and Family Services Case Activities.</span></p>', wordcount: 51 },
                                      { category: category_general_purpose, title: 'Adult Education Guidance Program',
                                        text: '<p><span style="color: rgb(102, 102, 102);">MIRA works with clients to address their educational needs, including assistance applying for college credit and training programs, evaluating educational credentials, and applying for financial aid. In FY18-19 MIRA provided 97 Adult Education Clients with 152 Adult Education Case Activities.</span></p>', wordcount: 44 },
                                      { category: category_general_purpose, title: 'Immigration Legal Services',
                                        text: '<p><span style="color: rgb(102, 102, 102);">The MIRA Immigration Legal Services Program assists with naturalization petitions and green card applications.&nbsp;There is no fee for the service, although application fees still apply. In FY18-19 MIRA assisted 240 clients with immigration legal services.</span></p>', wordcount: 39 }
                                    ])
